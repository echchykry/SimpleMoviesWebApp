...
namespace SimpleMoviesWebApp.Controllers
{
    public class MoviesController : Controller
    {
        ...
        private List<string> _allowedExtentions = new List<string> { ".jpg", ".png", ".jpeg" };
        ...
        public async Task<IActionResult> Create(MovieFormViewModel model)
        {
            ...
            {
                model.Genres = await _context.Genres.OrderBy(m => m.Name).ToListAsync();
                ModelState.AddModelError("Poster", "Please selecte movie poster!");
                return View("MovieForm", model);
            }
            ...
            {
                model.Genres = await _context.Genres.OrderBy(m => m.Name).ToListAsync();
                ModelState.AddModelError("Poster", "Please selecte image!");
                return View("MovieForm", model);
            }
